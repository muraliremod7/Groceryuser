...
public class DeosAndPerfumesFragment extends Fragment {
    ...
    public DeosAndPerfumesFragment() {
        // Required empty public constructor
    }

    public static DeosAndPerfumesFragment newInstance() {
        DeosAndPerfumesFragment cakesDairy = new DeosAndPerfumesFragment();
        return cakesDairy;
    }
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_deos_perfumes, container, false);
        gridview = (RecyclerView) view.findViewById(R.id.deosperfumesgridview);
        ...
        firebase = new Firebase("https://online-grocery-88ba4.firebaseio.com/DeosAndPerfumes");
        refreshdata();
    ...
    public  void refreshdata() {
        firebase.child("DeosAndPerfumes").orderByChild("ppid").addListenerForSingleValueEvent(new com.firebase.client.ValueEventListener() {
            @Override
